...
(function (ELang) {
    ...
    var ELangEdit = (function (_super) {
        ...
        ELangEdit.prototype.createContent = function () {
            ...
            keyField.find("input[placeholder]").attr("id", this.defaults.editKeyLabel).attr("placeholder", labelKey);
            valueField.find("input[placeholder]").attr("id", this.defaults.editValueLabel).attr("placeholder", labelValue);
